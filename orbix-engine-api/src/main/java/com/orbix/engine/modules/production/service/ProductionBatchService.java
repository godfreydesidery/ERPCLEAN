...
public interface ProductionBatchService {
     ...
     */
    ProductionBatchDto start(String uid);
     ...
     */
    ProductionBatchDto postOutput(String uid, PostProductionOutputRequestDto request);
     ...
     */
    ProductionBatchDto cancel(String uid);
     ...
     */
    ProductionBatchDto advanceLifecycle(String uid, AdvanceLifecycleRequestDto request);
     ...
     * written off).
     */
    ProductionBatchDto close(String uid);

    ProductionBatchDto get(String uid);
