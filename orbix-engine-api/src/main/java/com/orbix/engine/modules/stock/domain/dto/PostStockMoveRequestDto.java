 ...
 * @param sectionId            optional FK to {@code section}; stamped on the move
 * @param consumptionCategory  required for {@code INTERNAL_CONSUMPTION}; nullable otherwise
 * @param authorisedByUserId   required for internal-consumption / oversell /
 *                             above-threshold adjustments; nullable otherwise
 */
public record PostStockMoveRequestDto(
    ...
    public PostStockMoveRequestDto(Long itemId, Long branchId, BigDecimal qty, BigDecimal unitCost,
        ...
        this(itemId, branchId, qty, unitCost, moveType, refType, refId, notes, allowOversell,
            null, null, null, null);
    }

    public PostStockMoveRequestDto(Long itemId, Long branchId, BigDecimal qty, BigDecimal unitCost,
                                   StockMoveType moveType, String refType, Long refId,
                                   String notes, boolean allowOversell, Long batchId) {
        this(itemId, branchId, qty, unitCost, moveType, refType, refId, notes, allowOversell,
