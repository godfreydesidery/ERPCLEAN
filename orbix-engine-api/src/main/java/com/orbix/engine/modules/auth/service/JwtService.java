...
/**
 * Issues and parses JWTs. The scaffold uses HS256 for local development;
...
public class JwtService {
    ...
    public record Claims(Long userId, Long companyId, Long branchId, List<String> privileges) {}
}
