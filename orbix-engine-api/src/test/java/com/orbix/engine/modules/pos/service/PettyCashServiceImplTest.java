...
class PettyCashServiceImplTest {
    ...
    @Mock private PettyCashRepository payouts;
    ...
    private final AtomicLong nextId = new AtomicLong(6000);
    ...
    @Test
    void post_writesSingleOutTillEntryAndEmitsEvent() {
        ...
        when(permissions.resolve(SUPERVISOR_ID, COMPANY_ID, null))
            .thenReturn(Set.of("POS.PETTY_CASH"));

        service.post(new PostPettyCashRequestDto(
            SESSION_ID, new BigDecimal("2000"), PettyCashCategory.TRANSPORT,
            "Driver Sam", SUPERVISOR_ID, "Courier", null));
    ...
    void post_rejectsSelfAuthorisation() {
        ...
        PostPettyCashRequestDto req = new PostPettyCashRequestDto(
            SESSION_ID, new BigDecimal("2000"), PettyCashCategory.OTHER,
            null, ACTOR_ID, null, null);
