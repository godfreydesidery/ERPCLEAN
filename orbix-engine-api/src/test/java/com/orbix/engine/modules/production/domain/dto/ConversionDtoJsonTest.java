...
/**
 * Pin the JSON wire shape of {@link ConversionDto}: {@code uid} is the external
...
class ConversionDtoJsonTest {
    ...
    void id_and_fk_id_fields_serialise_as_strings_uid_stays_string() throws Exception {
        ...
        assertThat(json).contains("\"fromItemId\":\"540\"");
        assertThat(json).contains("\"fromUomId\":\"9\"");
        assertThat(json).contains("\"toItemId\":\"541\"");
        assertThat(json).contains("\"toUomId\":\"10\"");
        // Genuine numerics untouched.
        assertThat(json).contains("\"fromQty\":100.0000");
        assertThat(json).contains("\"toQty\":200.0000");
        assertThat(json).contains("\"unitCost\":5.0000");
    }
}
