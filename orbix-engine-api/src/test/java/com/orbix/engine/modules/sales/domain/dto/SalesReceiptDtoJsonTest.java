...
/**
 * Pin the JSON wire shape of {@link SalesReceiptDto}: {@code uid} is the
...
class SalesReceiptDtoJsonTest {
    ...
    void id_and_fk_id_fields_serialise_as_strings_uid_stays_string() throws Exception {
        ...
        assertThat(json).contains("\"totalAmount\":700.0000");
    }
}
