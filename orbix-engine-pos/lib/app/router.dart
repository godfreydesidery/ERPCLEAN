...
import '../features/cash/cash_pickup_screen.dart';
import '../features/cash/petty_cash_screen.dart';
...
import '../features/till_session/x_report_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/cash/pickup',   builder: (_, __) => const CashPickupScreen()),
      GoRoute(path: '/cash/petty',    builder: (_, __) => const PettyCashScreen()),
      GoRoute(path: '/till/x-report', builder: (_, __) => const XReportScreen()),
    ],
  );
});
